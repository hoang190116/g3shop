    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm " aria-current="page">New Order</li>
            </ol>
        </nav>
    </div>
</nav>
    ...
    <div id="note-full-container" class="note-has-grid row">
        ...
        <div class="col-md-3 single-note-item all-category">
            <div class="card card-body">
                ...
                <h5 class="note-title text-truncate w-75 mb-0">Order ID: ${o.bill_id}<i class="point fa fa-circle ml-1 font-10" style='color:#fff152'></i></h5>
                ...
                <div class="note-content">
                    <p class="note-inner-content text-muted badge badge-info" style="font-size: 15px;">Status: ${o.status}</p>
                </div>
                <div class="note-content">
                ...
                <div class="d-flex align-items-center">
                    <a href="${pageContext.request.contextPath }/emp/receive?id=${o.bill_id}" class="btn btn-light btn-lg btn-block rounded-pill"><i class="fa fa-check" aria-hidden="true"></i> Receive</a>
                </div>
            </div>
        </div>
        </c:forEach>
