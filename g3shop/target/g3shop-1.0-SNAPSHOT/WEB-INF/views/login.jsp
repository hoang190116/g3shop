                ...
                <form:form class="mx-1 mx-md-4" action="${pageContext.request.contextPath }/login" method="post" modelAttribute="account">
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <form:input path="uname" type="text" id="form3Example1c" class="form-control" onkeypress="return event.charCode != 32" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <form:input path="pass" type="password" id="form3Example4c" class="form-control" onkeypress="return event.charCode != 32" />
