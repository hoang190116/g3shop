                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <div class="col-lg-6">
                            <div class="input-group input-group-outline">
                                ...
                                <form:input path="fname" required="a" class="form-control rounded" maxlength="150" minlength="5"/>
                            </div>
                        </div>
                        </div>
                        <div class="row justify-content-md-center">
                        ...
                        <div class="col-lg-6">
                            <div class="input-group input-group-outline">
                                ...
                                <form:input type="password" path="pass" id="writePass" required="a" class="form-control rounded" maxlength="100" onkeypress="return event.charCode != 32"/>
