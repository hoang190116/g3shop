        ...
        <div class="col-md-8">
            <div class="container pb-5 mb-2">
                ...
                <div class="row pt-3 pb-5 mb-2">
                    ...
                    <div class="col-sm-6 mb-3"><a class="btn btn-style-1 btn-primary btn-block" href="${pageContext.request.contextPath }/checkoutCard"><i class="fe-icon-credit-card"></i>&nbsp;Card Payment</a></div>
                </div>
                                 ...
                                 output += "<div class='cart-item d-md-flex justify-content-between'><span class='remove-item delete-item' data-id='"+cartArray[i].product_id+"'><i class='fa fa-times'></i></span>"
                                            +"<div class='px-3 my-3' style='width:50%'>"
                                                +"<a class='cart-item-product' href='${pageContext.request.contextPath }/productView?id="+cartArray[i].product_id+"'>"
                                                    ...
                                                    +"<div class='cart-item-product-info'>"
                                                        +"<h4 class='cart-item-product-title' style='width:80%'>"+cartArray[i].name+"</h4><span><strong>Type:</strong> "+cartArray[i].genre+"</span><span><strong>Price:</strong> "+cartArray[i].price+"$</span>"
                                                    +"</div>"
                                                +"</a>"
                                            +"</div>"
