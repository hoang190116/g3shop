                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <h5 >
                                    <p class="small"> <a type= "submit" href="${pageContext.request.contextPath }/productView?id=${p.product_id}" class="text-dark overflow-ellipsis" data-title="${p.name}">${p.name}</a>
                            ...
                            <div class="d-flex justify-content-between ">
                                <div class="d-grid gap-2 mx-auto">
                                    <a type= "submit" href="${pageContext.request.contextPath }/productView?id=${p.product_id}" class="btn btn-warning btn-rounded"><i class="fa-solid fa-eye"> </i>View</a>
