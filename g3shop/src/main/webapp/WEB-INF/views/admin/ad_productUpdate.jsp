                ...
                function lengthImg(){
                    ...
                    function allowUpload(){
                        ...
                        function imageIsLoaded(e) {
                          $('#myImg').append('<img height="200px" width="200px" style="object-fit: contain; margin-top:15px; margin-right:20px; box-shadow: 0 4px 9px 4px rgba(0,0,0,0.20); border-radius: 15px" src=' + e.target.result + '>');
                        };
                        function rmvImg(){
                            $("#myImg > img").remove();
                        }
                    ...
                    function displayImg(){
                        ...
                        for(var i in imgList){
                            output += "<div class='containerImg'><img style='object-fit: contain' src=${pageContext.request.contextPath }/img/1/"+imgList[i].name+">"
