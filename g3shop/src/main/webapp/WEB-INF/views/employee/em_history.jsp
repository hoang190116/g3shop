    ...
    <div id="note-full-container" class="note-has-grid row">
        ...
        <div class="col-md-3 single-note-item all-category">
            <div class="card card-body">
                ...
                <h5 class="note-title text-truncate w-75 mb-0">Order ID: ${o.bill_id}<i class="point fa fa-circle ml-1 font-10" style='color:#4ff339'></i></h5>
                ...
                <div class="note-content">
                    <p class="note-inner-content text-muted badge badge-success" style="font-size: 15px;">Status: ${o.status}</p>
                </div>
                <div class="note-content">
                ...
                <div class="d-flex align-items-center">
                    <a href="${pageContext.request.contextPath }/emp/orderDetail?id=${o.bill_id}" class="btn btn-light btn-lg btn-block rounded-pill"><i class="fa-solid fa-eye"></i>View</a>
                </div>
            </div>
        </div>
        </c:forEach>
